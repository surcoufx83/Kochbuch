...
class RecipeReadingRoute extends Route implements RouteInterface
{
  ...
  static function createOutput(array &$response): void
  {
    ...
    // Recipe view() method will return integer return code to use as browser response
    $Controller->e($recipe->view());
  }
